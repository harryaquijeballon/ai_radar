...
2. Run the **social-science-radar** daily scan (P6 → P8), then the
   **ai-engineering-radar** daily scan. Lookback per P6.1 (strictly before
   today, Europe/London, 7-day cap).
...
6. Last action, mandatory: write the scan-evidence artifact, then run the
   three-point success check above before ending your turn.
