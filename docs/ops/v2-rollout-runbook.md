...
| 9 | Pilot — 2-4 weeks of every-run notifications, then record the R38 decision (keep or failure-only) and the R45 decision (keep `full` dispatch mode or restrict) here | **in progress from 2026-07-24** | Observation mode: no further engineering during the pilot absent a real failure, quality problem, or material operational issue (user instruction 2026-07-23). Review due 2026-08-07 to 2026-08-20 |
